...
- **C1 (2/20):** Subjunctive Mood & Formal Structures ✅ escrito, aguardando aplicação, Nuance, Hedging & Academic Register ✅ escrito, aguardando aplicação, Vocabulário acadêmico, Escrita formal, Expressões idiomáticas avançadas, Pronúncia refinada (Apresentações profissionais e Negociação já foram adiantadas pro B2 — ver acima)
...
- `082_seed_c1_subjunctive_formal_structures.sql` — conteúdo C1 (módulo 1 "Subjunctive Mood & Formal Structures", 5 lições, 30 palavras, 71 exercícios) — **abre o C1 (1/20)** — escrito, pendente de aplicar
- `083_seed_c1_nuance_hedging_academic_register.sql` — conteúdo C1 (módulo 2 "Nuance, Hedging & Academic Register", 5 lições, 30 palavras, 71 exercícios) — escrito, pendente de aplicar
...
**A1, A2, B1 e B2 100% completos (15/15, 15/15, 20/20 e 20/20). C1 iniciado (2/20).** O B1 foi construído em lotes de 1-2 módulos, começando pela leva de referência original (Present Perfect, Modal Verbs, Passive Voice, Reported Speech, Phrasal Verbs, Email Writing, Listening) e depois adiantando temas do B2/C1 (Conditionals, Relative Clauses, Idioms, Business English, Reported Speech completo, Passive avançada, Debate e Argumentação, Past Perfect & Narrative Tenses, Gerúndios e Infinitivos, Meio Ambiente e Sustentabilidade, Perguntas Indiretas e Question Tags, Saúde e Bem-estar, Tecnologia e Redes Sociais). O B2 foi construído dando continuidade direta a temas do B1, além de temas novos: Third Conditional & Mixed Conditionals, Modal Verbs of Deduction — Passado, Relative Clauses Avançado, Ênfase e Inversão, Phrasal Verbs Avançados, Inglês de Negócios Avançado, Cleft Sentences, Entrevistas de Emprego e Carreira, Passive Voice Avançado, Reported Speech Avançado, Mixed Emphatic Structures & Discourse Markers, Prepositional Phrases & Dependent Prepositions Avançado, Academic & Formal Writing Vocabulary, Advanced Time Expressions & Narrative Sequencing, Environment & Global Issues Vocabulary Avançado, Idioms & Collocations Avançados, Negotiation & Persuasion Language, Formal & Professional Email Writing Avançado, Professional Presentations & Public Speaking e, por fim, B2 Mixed Review — Grammar & Vocabulary Consolidation, que fechou o nível revisando as principais estruturas do B2 inteiro. O C1 começou com Subjunctive Mood & Formal Structures e Nuance, Hedging & Academic Register (módulos 082/083, escritos e pendentes de aplicação no Supabase). Próximo passo: Márcio aplicar o SQL dos módulos 082/083 no Supabase e confirmar.

- Módulo C1 "Subjunctive Mood & Formal Structures" + módulo C1 "Nuance, Hedging & Academic Register" — ✅ escrito, aguardando aplicação — **abre o C1 (2/20)**
