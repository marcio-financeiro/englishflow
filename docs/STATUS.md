...
- **B1 (9/20):** Present Perfect ✅, Modal verbs ✅, Passive Voice ✅, Reported Speech (introdução) ✅, Phrasal verbs básicos ✅, Writing de e-mails ✅, Listening intermediário ✅, Conditionals (1st & 2nd) ✅, Relative Clauses (introdução) ✅
...
**A1 e A2 completos (15/15 módulos cada). B1 em andamento (9/20 módulos, todos aplicados no Supabase).** Depois de fechar a leva de referência original, avançamos com dois temas adiantados do B2 (Conditionals e Relative Clauses, com profundidade B1). Próximo passo: confirmar com o Márcio o próximo lote pra continuar rumo aos 20 módulos do B1 (ex: Idioms, Business English básico, Reported Speech completo).
