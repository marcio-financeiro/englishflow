...
>
> **Última atualização:** 2026-08-05 · **Estado:** MVP (Fases 0–6) em produção · Redesign visual completo · seguindo roadmap CEFR (A1→C2, ver seção abaixo).
...
| B2 | Intermediário Avançado | 20 | 20 ✅ COMPLETO |
| C1 | Avançado | 20 | 8 |
...
- **B2 (20/20 ✅ COMPLETO):** Third Conditional & Mixed Conditionals ✅, Modal Verbs of Deduction (Passado) ✅, Relative Clauses Avançado ✅, Ênfase e Inversão ✅, Phrasal Verbs Avançados ✅, Inglês de Negócios Avançado ✅, Cleft Sentences ✅, Entrevistas de Emprego e Carreira ✅, Passive Voice Avançado ✅, Reported Speech Avançado ✅, Mixed Emphatic Structures & Discourse Markers ✅, Prepositional Phrases & Dependent Prepositions Avançado ✅, Academic & Formal Writing Vocabulary ✅, Advanced Time Expressions & Narrative Sequencing ✅, Environment & Global Issues Vocabulary Avançado ✅, Idioms & Collocations Avançados ✅, Negotiation & Persuasion Language ✅, Formal & Professional Email Writing Avançado ✅, Professional Presentations & Public Speaking ✅, B2 Mixed Review — Grammar & Vocabulary Consolidation ✅. (Conditionals, Relative Clauses intro, Idioms, Business English básico, Reported Speech completo, Passive avançada, Debate e Argumentação, Past Perfect & Narrative Tenses, Gerúndios e Infinitivos, Meio Ambiente e Sustentabilidade, Perguntas Indiretas e Question Tags, Saúde e Bem-estar e Tecnologia e Redes Sociais já foram adiantados pro B1 — ver acima)
- **C1 (8/20):** Subjunctive Mood & Formal Structures ✅, Nuance, Hedging & Academic Register ✅, Participle Clauses & Sentence Reduction ✅, Idiomatic & Figurative Language (C1) ✅, Academic Vocabulary & Nominalization ✅, Cohesion & Formal Essay Writing ✅, Pronunciation & Connected Speech (C1) ✅ escrito, aguardando aplicação, Formal Inversion & Hypothetical Structures ✅ escrito, aguardando aplicação (Apresentações profissionais e Negociação já foram adiantadas pro B2 — ver acima)
...
- `047_seed_b1_email_writing.sql` — conteúdo B1 (módulo 6 "Email Writing", 5 lições, 30 palavras, 71 exercícios)
- `048_seed_b1_listening_skills.sql` — conteúdo B1 (módulo 7 "Listening Intermediário", 5 lições, 30 palavras, 71 exercícios) — **fecha a primeira leva de temas do roadmap B1**
- `049_seed_b1_conditionals.sql` — conteúdo B1 (módulo 8 "Conditionals", 1st & 2nd, 5 lições, 30 palavras, 71 exercícios)
- `050_seed_b1_relative_clauses.sql` — conteúdo B1 (módulo 9 "Relative Clauses", introdução, 5 lições, 30 palavras, 71 exercícios)
- `051_seed_b1_idioms.sql` — conteúdo B1 (módulo 10 "Idioms", 5 lições, 30 idioms, 71 exercícios)
...
- `057_seed_b1_gerunds_infinitives.sql` — conteúdo B1 (módulo 16 "Gerúndios e Infinitivos", 5 lições, 30 palavras, 71 exercícios)
...
- `062_seed_b2_third_conditional.sql` — conteúdo B2 (módulo 1 "Third Conditional & Mixed Conditionals", 5 lições, 30 palavras, 71 exercícios) — **abre o B2**
- `063_seed_b2_modal_deduction_past.sql` — conteúdo B2 (módulo 2 "Modal Verbs of Deduction — Passado", 5 lições, 30 palavras, 71 exercícios, tema de investigação/mistério)
- `064_seed_b2_advanced_relative_clauses.sql` — conteúdo B2 (módulo 3 "Relative Clauses Avançado", 5 lições, 30 palavras, 71 exercícios)
...
- `070_seed_b2_passive_voice_advanced.sql` — conteúdo B2 (módulo 9 "Passive Voice Avançado", 5 lições, 30 palavras, 71 exercícios)
- `071_seed_b2_reported_speech_advanced.sql` — conteúdo B2 (módulo 10 "Reported Speech Avançado", 5 lições, 30 palavras, 71 exercícios)
- `072_seed_b2_discourse_markers.sql` — conteúdo B2 (módulo 11 "Mixed Emphatic Structures & Discourse Markers", 5 lições, 30 palavras, 71 exercícios)
- `073_seed_b2_dependent_prepositions.sql` — conteúdo B2 (módulo 12 "Prepositional Phrases & Dependent Prepositions Avançado", 5 lições, 30 palavras, 71 exercícios)
- `074_seed_b2_academic_writing_vocabulary.sql` — conteúdo B2 (módulo 13 "Academic & Formal Writing Vocabulary", 5 lições, 30 palavras, 71 exercícios)
- `075_seed_b2_advanced_time_expressions.sql` — conteúdo B2 (módulo 14 "Advanced Time Expressions & Narrative Sequencing", 5 lições, 30 palavras, 71 exercícios)
- `076_seed_b2_environment_advanced.sql` — conteúdo B2 (módulo 15 "Environment & Global Issues Vocabulary Avançado", 5 lições, 30 palavras, 71 exercícios)
- `077_seed_b2_idioms_collocations_advanced.sql` — conteúdo B2 (módulo 16 "Idioms & Collocations Avançados", 5 lições, 30 palavras, 71 exercícios)
- `078_seed_b2_negotiation_persuasion.sql` — conteúdo B2 (módulo 17 "Negotiation & Persuasion Language", 5 lições, 30 palavras, 71 exercícios)
- `079_seed_b2_formal_email_writing_advanced.sql` — conteúdo B2 (módulo 18 "Formal & Professional Email Writing Avançado", 5 lições, 30 palavras, 71 exercícios)
- `080_seed_b2_presentations_public_speaking.sql` — conteúdo B2 (módulo 19 "Professional Presentations & Public Speaking", 5 lições, 30 palavras, 71 exercícios)
- `081_seed_b2_mixed_review.sql` — conteúdo B2 (módulo 20 "B2 Mixed Review — Grammar & Vocabulary Consolidation", 5 lições, 30 palavras, 71 exercícios) — **completa o B2 (20/20)**
- `082_seed_c1_subjunctive_formal_structures.sql` — conteúdo C1 (módulo 1 "Subjunctive Mood & Formal Structures", 5 lições, 30 palavras, 71 exercícios) — **abre o C1 (1/20)**
- `083_seed_c1_nuance_hedging_academic_register.sql` — conteúdo C1 (módulo 2 "Nuance, Hedging & Academic Register", 5 lições, 30 palavras, 71 exercícios) — **C1 em 2/20**
- `084_seed_c1_participle_clauses_reduction.sql` — conteúdo C1 (módulo 3 "Participle Clauses & Sentence Reduction", 5 lições, 30 palavras, 71 exercícios)
- `085_seed_c1_idiomatic_figurative_language.sql` — conteúdo C1 (módulo 4 "Idiomatic & Figurative Language (C1)", 5 lições, 30 palavras, 71 exercícios) — **C1 em 4/20**
- `086_seed_c1_academic_vocabulary_nominalization.sql` — conteúdo C1 (módulo 5 "Academic Vocabulary & Nominalization", 5 lições, 30 palavras, 71 exercícios)
- `087_seed_c1_cohesion_formal_essay_writing.sql` — conteúdo C1 (módulo 6 "Cohesion & Formal Essay Writing", 5 lições, 30 palavras, 71 exercícios) — **C1 em 6/20**
- `088_seed_c1_pronunciation_connected_speech.sql` — conteúdo C1 (módulo 7 "Pronunciation & Connected Speech (C1)", 5 lições, 30 palavras, 71 exercícios) — escrito, pendente de aplicar
- `089_seed_c1_formal_inversion_hypothetical.sql` — conteúdo C1 (módulo 8 "Formal Inversion & Hypothetical Structures", 5 lições, 30 palavras, 71 exercícios) — **C1 em 8/20** — escrito, pendente de aplicar
...
**A1, A2, B1 e B2 100% completos (15/15, 15/15, 20/20 e 20/20). C1 em andamento (8/20).** O B1 foi construído em lotes de 1-2 módulos, começando pela leva de referência original (Present Perfect, Modal Verbs, Passive Voice, Reported Speech, Phrasal Verbs, Email Writing, Listening) e depois adiantando temas do B2/C1 (Conditionals, Relative Clauses, Idioms, Business English, Reported Speech completo, Passive avançada, Debate e Argumentação, Past Perfect & Narrative Tenses, Gerúndios e Infinitivos, Meio Ambiente e Sustentabilidade, Perguntas Indiretas e Question Tags, Saúde e Bem-estar, Tecnologia e Redes Sociais). O B2 foi construído dando continuidade direta a temas do B1, além de temas novos: Third Conditional & Mixed Conditionals, Modal Verbs of Deduction — Passado, Relative Clauses Avançado, Ênfase e Inversão, Phrasal Verbs Avançados, Inglês de Negócios Avançado, Cleft Sentences, Entrevistas de Emprego e Carreira, Passive Voice Avançado, Reported Speech Avançado, Mixed Emphatic Structures & Discourse Markers, Prepositional Phrases & Dependent Prepositions Avançado, Academic & Formal Writing Vocabulary, Advanced Time Expressions & Narrative Sequencing, Environment & Global Issues Vocabulary Avançado, Idioms & Collocations Avançados, Negotiation & Persuasion Language, Formal & Professional Email Writing Avançado, Professional Presentations & Public Speaking e, por fim, B2 Mixed Review — Grammar & Vocabulary Consolidation, que fechou o nível revisando as principais estruturas do B2 inteiro. O C1 começou com Subjunctive Mood & Formal Structures e Nuance, Hedging & Academic Register, continuou com Participle Clauses & Sentence Reduction, Idiomatic & Figurative Language, Academic Vocabulary & Nominalization e Cohesion & Formal Essay Writing, e agora tem Pronunciation & Connected Speech e Formal Inversion & Hypothetical Structures (módulos 088/089, escritos e pendentes de aplicação no Supabase). Próximo passo: Márcio aplicar o SQL dos módulos 088/089 no Supabase e confirmar.

- Módulo C1 "Pronunciation & Connected Speech (C1)" + módulo C1 "Formal Inversion & Hypothetical Structures" — ✅ escrito, aguardando aplicação — **C1 em 8/20**
- Módulo C1 "Academic Vocabulary & Nominalization" + módulo C1 "Cohesion & Formal Essay Writing" — ✅ feito e aplicado no Supabase — **C1 em 6/20**
- Módulo C1 "Participle Clauses & Sentence Reduction" + módulo C1 "Idiomatic & Figurative Language (C1)" — ✅ feito e aplicado no Supabase — **C1 em 4/20**
- Módulo C1 "Subjunctive Mood & Formal Structures" + módulo C1 "Nuance, Hedging & Academic Register" — ✅ feito e aplicado no Supabase — **abre o C1 (2/20)**
- Módulo B2 "Professional Presentations & Public Speaking" + módulo B2 "B2 Mixed Review — Grammar & Vocabulary Consolidation" — ✅ feito e aplicado no Supabase — **B2 em 20/20 — NÍVEL COMPLETO 🎉**
- Módulo B2 "Negotiation & Persuasion Language" + módulo B2 "Formal & Professional Email Writing Avançado" — ✅ feito e aplicado no Supabase — **B2 em 18/20**
- Módulo B2 "Environment & Global Issues Vocabulary Avançado" + módulo B2 "Idioms & Collocations Avançados" — ✅ feito e aplicado no Supabase — **B2 em 16/20**
- Módulo B2 "Academic & Formal Writing Vocabulary" + módulo B2 "Advanced Time Expressions & Narrative Sequencing" — ✅ feito e aplicado no Supabase — **B2 em 14/20**
- Módulo B2 "Mixed Emphatic Structures & Discourse Markers" + módulo B2 "Prepositional Phrases & Dependent Prepositions Avançado" — ✅ feito e aplicado no Supabase — **B2 em 12/20**
- Módulo B2 "Passive Voice Avançado" + módulo B2 "Reported Speech Avançado" — ✅ feito e aplicado no Supabase — **B2 em 10/20**
- Módulo B2 "Cleft Sentences" + módulo B2 "Entrevistas de Emprego e Carreira" — ✅ feito e aplicado no Supabase — **B2 em 8/20**
