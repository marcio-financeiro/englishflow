...
| A1 | Iniciante | 15 | 15 ✅ |
| A2 | Básico | 15 | 15 ✅ |
| B1 | Intermediário | 20 | 7 (+2 escritos, pendentes de aplicar) |
...
- **B1 (7/20 aplicados, +2 escritos pendentes):** Present Perfect ✅, Modal verbs ✅, Passive Voice ✅, Reported Speech (introdução) ✅, Phrasal verbs básicos ✅, Writing de e-mails ✅, Listening intermediário ✅, Conditionals (1st & 2nd) — escrito, pendente de aplicar, Relative Clauses (introdução) — escrito, pendente de aplicar
- **B2:** Reported Speech completo, Passive avançada, Idioms, Debate e argumentação, Business English básico (Conditionals e Relative Clauses adiantados pro B1 — ver acima)
...
**A1 e A2 completos (15/15 módulos cada). B1 em andamento (7/20 módulos aplicados, +2 escritos aguardando aplicar).** Depois de fechar a leva de referência original, avançamos com dois temas adiantados do B2 (Conditionals e Relative Clauses, com profundidade B1). Próximo passo: confirmar com o Márcio o próximo lote pra continuar rumo aos 20 módulos do B1 (ex: Idioms, Business English básico, Reported Speech completo).

- Módulo B1 "Conditionals" (1st & 2nd) + módulo B1 "Relative Clauses" (introdução) — ✅ escrito, aguardando aplicação no Supabase — **B1 em 9/20 quando aplicado**
