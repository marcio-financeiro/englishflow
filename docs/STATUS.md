...
| B2 | Intermediário Avançado | 20 | 20 (escritos, pendentes de aplicar) |
| C1 | Avançado | 20 | 0 |
...
**A1 e A2 100% completos (15/15 cada). B1 100% completo (20/20). B2 quase completo (18/20 aplicados, 20/20 escrito).** O B1 foi construído em lotes de 1-2 módulos, começando pela leva de referência original (Present Perfect, Modal Verbs, Passive Voice, Reported Speech, Phrasal Verbs, Email Writing, Listening) e depois adiantando temas do B2/C1 (Conditionals, Relative Clauses, Idioms, Business English, Reported Speech completo, Passive avançada, Debate e Argumentação, Past Perfect & Narrative Tenses, Gerúndios e Infinitivos, Meio Ambiente e Sustentabilidade, Perguntas Indiretas e Question Tags, Saúde e Bem-estar, Tecnologia e Redes Sociais). O B2 vem sendo construído dando continuidade direta a temas do B1, além de temas novos: Third Conditional & Mixed Conditionals, Modal Verbs of Deduction — Passado, Relative Clauses Avançado, Ênfase e Inversão, Phrasal Verbs Avançados, Inglês de Negócios Avançado, Cleft Sentences (continua Ênfase e Inversão), Entrevistas de Emprego e Carreira, Passive Voice Avançado, Reported Speech Avançado, Mixed Emphatic Structures & Discourse Markers (continua Debate e Argumentação), Prepositional Phrases & Dependent Prepositions Avançado, Academic & Formal Writing Vocabulary (prepara terreno pro C1), Advanced Time Expressions & Narrative Sequencing (continua Past Perfect & Narrative Tenses), Environment & Global Issues Vocabulary Avançado (continua Meio Ambiente e Sustentabilidade), Idioms & Collocations Avançados (continua Idioms), Negotiation & Persuasion Language (continua Inglês de Negócios Avançado, adianta "negociação" do C1), Formal & Professional Email Writing Avançado (continua Email Writing do B1), Professional Presentations & Public Speaking (adianta "apresentações profissionais" do C1) e B2 Mixed Review — Grammar & Vocabulary Consolidation (módulo de fechamento do nível, revisando as principais estruturas do B2 inteiro). Próximo passo: Márcio rodar os SQLs de 080 e 081 no Supabase — isso completa o B2 (20/20) 🎉

- Módulo B2 "Professional Presentations & Public Speaking" + módulo B2 "B2 Mixed Review — Grammar & Vocabulary Consolidation" — ✅ escrito, aguardando aplicação no Supabase — **B2 em 20/20 (18 aplicados) — COMPLETA O NÍVEL**
