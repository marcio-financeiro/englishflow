...
- `088_seed_c1_pronunciation_connected_speech.sql` — conteúdo C1 (módulo 7 "Pronunciation & Connected Speech (C1)", 5 lições, 30 palavras, 71 exercícios)
- `089_seed_c1_formal_inversion_hypothetical.sql` — conteúdo C1 (módulo 8 "Formal Inversion & Hypothetical Structures", 5 lições, 30 palavras, 71 exercícios) — **C1 em 8/20**
