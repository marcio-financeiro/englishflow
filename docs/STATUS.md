...
- **C1 (4/20):** Subjunctive Mood & Formal Structures ✅, Nuance, Hedging & Academic Register ✅, Participle Clauses & Sentence Reduction ✅, Idiomatic & Figurative Language (C1) ✅, Vocabulário acadêmico, Escrita formal, Pronúncia refinada (Apresentações profissionais e Negociação já foram adiantadas pro B2 — ver acima)
